...
/**
 * The root of a parsed source file: top-level function and struct
 ...
 */
public record Program(List<FunctionDeclaration> functions, List<StructDeclaration> structs, SourceRange range)
        implements ASTNode {
}
